...
#def edge_histogram_descriptor2(frame):
...
PATH_BASE = "drive/My Drive/Colab Notebooks/Curet_modificado/"
...
CSV_ENTRENAMIENTO = "/content/drive/MyDrive/Colab Notebooks/resultados/EHD_Outex13_entrenamiento.csv"
...
######### PRUEBA DEL EDGE HISTORAM DESCRIPTOR PARA UNA IMAGEN #########
img_prueba = cv2.imread('drive/My Drive/Colab Notebooks/Outex_TC_00013/images/000000.bmp')
resultado = edge_histogram_descriptor(img_prueba)
print(len(resultado))
resultado