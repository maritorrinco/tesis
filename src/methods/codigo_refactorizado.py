# -*- coding: utf-8 -*-
"""Código refactorizado.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1g7H9F8MYCtW_lmKFY66-SFXHQgyzVqQN
"""
...
CSV_PATH = "/content/drive/MyDrive/Colab Notebooks/resultados/resultados" + FECHA_HORA + ".csv"
...
def test(imagenes, svm, vectorizer, vectorizer_B, vectorizer_G, vectorizer_R, characters, windows, step, _range):
  ...
  print("antes de svm test")
  predicciones = svm.predict(histogramas_img_prueba)
...
def experiment(_range, windows, step, imagenes_entrenamiento, labels_entrenamiento, imagenes_prueba, labels_prueba, characters):
  ...
  print("test...")
  predicciones = test(imagenes_prueba, svm, vectorizer, vectorizer_B, vectorizer_G, vectorizer_R, characters, windows, step, _range)
